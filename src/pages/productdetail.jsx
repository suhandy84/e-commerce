                    ...
                    if (res1.data.length) {
                        ...
                        Axios.get(`${API_URL}/transactiondetails?transactionId=${res1.data[0].id}&productId=${data.id}`)
                            .then((res2) => {
                                console.log(res2)
                                if (res2.data.length) {
                                    objdetails.qty = parseInt(res2.data[0].qty) + parseInt(qty)
                                    objdetails.totalharga=objdetails.qty*data.harga
                                    Axios.put(`${API_URL}/transactiondetails/${res2.data[0].id}`, objdetails)
                                        .then((res3) => {
                                    ...
                                    Axios.post(`${API_URL}/transactiondetails`, objdetails)
                                        ...
                                        props.TotalQty(props.Cart.totalqty+1)
                                    }
                            })
                            ...
                            .then((res5) => {
                                ...
                                Axios.post(`${API_URL}/transactiondetails`, objdetails)
                                    .then((res6) => {
                                        ...
                                        Swal.fire({
                                            icon: 'success',
                                            title: 'Selamat barang anda berhasil masuk cart',
                                            // text: 'Barang masuk ke cart',
                                        })
                                    })
                                })
...
export default connect(MapstatetoProps,{TotalQty})(ProductDetail)